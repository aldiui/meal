    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url("admin/sales_menu/rolling_sales");?>" method="get">
                        <div class="row">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mb-2">
                                    ...
                                    <input class="result form-control" type="text" value="<?= @$username["nama"] ?>"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-12">
        ...
        <div class="col-12">
            <?php if($olah == "input"):?>
            <form action="<?= base_url("admin/sales_menu/tambah_rs/").@$date."/". @$username["id"] ;?>" method="post">
                <div class="card">
                    <div class="card-header">
            ...
            <form action="<?= base_url("admin/sales_menu/edit_rs/").@$date."/". @$username["id"] ;?>" method="post">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Persediaan</div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if($br["sediaan{$i}"] > 0):?> <input type="hidden"
                                                value="<?= $br["qty{$i}"];?>" id="qtyp<?= $i . $pj['id'] ?>">
