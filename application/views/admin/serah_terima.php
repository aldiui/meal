    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url("admin/serah_terima/cari");?>" method="post">
                        <div class="row">
                            <div class="col-lg-6">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <a href="<?= base_url("admin/serah_terima/filter");?>"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a type="button" class="btn btn-warning btn-sm"
                                            href="<?= base_url("admin/serah_terima/filter?tanggal=").$row["tanggal"]."&sales=".$row["user_id"];?>"><i
                                                class="bx bx-edit"></i>
                                        </a>
                                    </td>
                                </tr>
