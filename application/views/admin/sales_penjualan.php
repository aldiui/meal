        ...
        <div class="col-12">
                        ...
                        <table id="example50" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $s["nama_barang"];?></td>
                                    <td>
                                        <a type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#edit<?= $s["id"];?>"><i class="bx bx-edit"></i></a>
                                        <div class="modal fade" id="edit<?= $s["id"];?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <form action="<?= base_url("admin/sales_penjualan/edit");?>" method="post">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="modal-title">Edit Data <?= $title;?> ?</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <input type="text" class="form-control" name="kode_barang" id="kode_barang" value="<?= $s["kode_barang"];?>" readonly>
                                                            </div>
                                                            <div class="form-group mb-2">
                                                                <label for="nama_barang" class="form-label">Nama Barang</label>
                                                                <input type="text" class="form-control" name="nama_barang" id="nama_barang" value="<?= $s["nama_barang"];?>" readonly>
                                                            </div>
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <option value="">Kosongkan ...</option>
                                                                    <?php foreach($penjualan as $p):?>
                                                                        <?php if($p["id"] == $s["sediaan_id"]):?>
                                                                            <option value="<?= $p["id"];?>" selected><?= getBarang($p["barang_id"]);?></option>
                                                                        <?php else:?>
                                                                            <option value="<?= $p["id"];?>"><?= getBarang($p["barang_id"]);?></option>
                                                                        <?php endif;?>
                                                                    <?php endforeach;?>
                                                                </select>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6 mb-2">
                                                                    ...
                                                                    <input type="number" name="qty2" class="form-control" value="<?= $s["qty2"];?>">
                                                                </div>
                                                                <div class="col-lg-6 mb-2">
                                                                ...
                                                                <div class="col-lg-6 mb-2">
                                                                    ...
                                                                    <input type="number" name="qty3" class="form-control" value="<?= $s["qty3"];?>">
                                                                </div>
                                                                <div class="col-lg-6 mb-2">
                                                                ...
                                                                <div class="col-lg-6 mb-2">
                                                                    ...
                                                                    <input type="number" name="qty4" class="form-control" value="<?= $s["qty4"];?>">
                                                                </div>
                                                                <div class="col-lg-6 mb-2">
                                                                ...
                                                                <div class="col-lg-6 mb-2">
                                                                    ...
                                                                    <input type="number" name="qty5" class="form-control" value="<?= $s["qty5"];?>">
                                                                </div>
                                                                <div class="col-lg-6 mb-2">
                                                                ...
                                                                <div class="col-lg-6 mb-2">
                                                                    ...
                                                                    <input type="number" name="qty6" class="form-control" value="<?= $s["qty6"];?>">
                                                                </div>
                                                                <div class="col-lg-6 mb-2">
                                                                ...
                                                                <div class="col-lg-6 mb-2">
                                                                    ...
                                                                    <input type="number" name="qty7" class="form-control" value="<?= $s["qty7"];?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <a type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapus<?= $s["id"];?>"><i class="bx bx-trash"></i></a>
                                        <div class="modal fade" id="hapus<?= $s["id"];?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <form action="<?= base_url("admin/sales_penjualan/delete/").$s["barang_id"];?>" method="post">
                                                        <div class="modal-header">
            ...
            <div class="modal fade" id="tambah" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <form action="<?= base_url("admin/sales_penjualan/tambah");?>" method="post">
                            <div class="modal-header">
                            ...
                            <table class="table table-bordered table-striped" id="example">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><input type="checkbox" classa="form-check-input" name="checkbox[]" value="<?= $row['id']; ?>"></td>
