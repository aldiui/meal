    ...
    <div class="row">
        ...
        <div class="col-12">
                                        ...
                                        <div class="modal fade" id="hapus<?= $s["id"];?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <form action="<?= base_url("admin/master_template/delete/").$s["barang_id"];?>" method="post">
            ...
            <div class="modal fade" id="tambah" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <form action="<?= base_url("admin/master_template/tambah");?>" method="post">
                            <div class="modal-header">
                            ...
                            <table class="table table-bordered table-striped" id="example">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input" name="checkbox[]" value="<?= $row['id']; ?>"></td>
