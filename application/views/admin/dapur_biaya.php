                        ...
                        <table id="example50" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= getAkun($a["akun_id"]);?></td>
                                    <td>
                                        <a type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#edit<?= $a["id_biaya"];?>"> 
                                            <i class="bx bx-edit"></i>
                                        </a>
                                        <div class="modal fade" id="edit<?= $a["id_biaya"];?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <form action="<?= base_url("admin/dapur_biaya/edit");?>" method="post">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="modal-title">Edit Data</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <input type="hidden" name="id" value="<?= $a["id_biaya"];?>">
                                                            <div class="form-group mb-2">
                                                                <label for="kode_biaya1" class="form-label">Kode Biaya</label>
                                                                <input type="text" class="form-control" name="kode_biaya1" id="kode_biaya1" value="<?= $a["kode_biaya"];?>" required>
                                                                <?= form_error("kode_biaya1", '<small class="text-danger">', '</small>');?>
                                                            </div>
                                                            <div class="form-group mb-2">
                                                                <label for="nama_biaya1" class="form-label">Nama Biaya</label>
                                                                <input type="text" class="form-control" name="nama_biaya1" id="nama_biaya1" value="<?= $a["nama_biaya"];?>" required>
                                                                <?= form_error("nama_biaya1", '<small class="text-danger">', '</small>');?>
                                                            </div>
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <select name="jenis_biaya1" class="form-control" id="jenis_biaya1">
                                                                    <?php foreach($jenis as $j):?>
                                                                        <?php if($j["no"] == $a["jenis_biaya"]):?>
                                                                            <option value="<?= $j["no"];?>" selected><?= $j["jenis"];?></option>
                                                                        <?php else:?>
                                                                            <option value="<?= $j["no"];?>"><?= $j["jenis"];?></option>
                                                                        <?php endif;?>
                                                                    <?php endforeach;?>
                                                                </select>
                                                                <?= form_error("jenis_biaya1", '<small class="text-danger">', '</small>');?>
                                                            </div>
                                                                ...
                                                                <select name="tipe_akun1" class="form-control" id="tipe_akun1" required>
                                                                    <?php foreach($tipe as $t):?>
                                                                        <?php if($t["id"] == $a["akun_id"]):?>
                                                                            <option value="<?= $t["id"];?>" selected><?= $t["kode_akun"];?> - <?= $t["nama_akun"];?></option>
                                                                        <?php else:?>
                                                                            <option value="<?= $t["id"];?>"><?= $t["kode_akun"];?> - <?= $t["nama_akun"];?></option>
                                                                        <?php endif;?>
                                                                    <?php endforeach;?>
                                                                </select>
                                        ...
                                        <div class="modal fade" id="hapus<?= $a["id_biaya"];?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <form action="<?= base_url("admin/dapur_biaya/delete/").$a["id_biaya"];?>" method="post">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <input type="text" class="form-control" name="kode_biaya" id="kode_biaya" value="<?= $a["kode_biaya"];?>" readonly>
                                                            </div>
                                                            <div class="form-group mb-2">
                                                                <label for="nama_biaya" class="form-label">Nama Akun</label>
                                                                <input type="text" class="form-control" name="nama_biaya" id="nama_biaya" value="<?= $a["nama_biaya"];?>" readonly>
                                                            </div>
                                                            <div class="form-group mb-2">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="modal-body">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" name="kode_biaya" id="kode_biaya" value="<?= set_value("kode_biaya");?>" required>
                                    <?= form_error("kode_biaya", '<small class="text-danger">', '</small>');?>
                                </div>
                                <div class="form-group mb-2">
                                    <label for="nama_biaya" class="form-label">Nama Biaya</label>
                                    <input type="text" class="form-control" name="nama_biaya" id="nama_biaya" value="<?= set_value("nama_biaya");?>" required>
                                    <?= form_error("nama_biaya", '<small class="text-danger">', '</small>');?>
                                </div>
                                <div class="form-group">
                                    <label for="jenis_biaya" class="form-label">Jenis Biaya</label>
                                    ...
                                    <?= form_error("jenis_biaya", '<small class="text-danger">', '</small>');?>
                                </div>
                                <div class="form-group">
