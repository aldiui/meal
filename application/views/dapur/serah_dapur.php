    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo base_url('dapur/serah_terima/filter'); ?>" method="get">
                        <div class="row">
                            <div class="col-lg-6">
        ...
        <div class="col-12">
            ...
            <form action="<?php echo base_url('dapur/serah_terima/tambah/'.$date.'/'.$sales2); ?>" method="post">
                <div class="card">
                    <div class="card-header">
            ...
            <form action="<?php echo base_url('dapur/serah_terima/edit/'.$date.'/'.$sales2); ?>" method="post">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Data <?php echo $title; ?></div>
                    </div>
