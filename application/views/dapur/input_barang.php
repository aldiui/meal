    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url("dapur/dapur_menu/filter");?>" method="post">
        ...
        <?php if($olah == "input"):?>
        <form action="<?= base_url("dapur/dapur_menu/tambah/").@$date."/".@$trx ;?>" method="post">
        ...
        <form action="<?= base_url("dapur/dapur_menu/edit/").@$date."/".@$trx ;?>" method="post">
            <input type="hidden" name="no_dok" value="<?= $no_dok;?>">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
