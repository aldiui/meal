    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo base_url('dapur/dapur_menu/filter'); ?>" method="post">
                        <div class="form-group mb-2">
                            <label for="dapur" class="form-label">Dapur</label>
                            <select name="dapur" class="form-control" id="dapur" required>
                                <option value="">Pilih...</option>
                                <?php foreach ($dapur_admin as $dp) { ?>
                                <option value="<?php echo $dp['id']; ?>"><?php echo $dp['username']; ?></option>
                                <?php }?>
                            </select>
                        </div>
        ...
        <?php if ($olah == 'input') { ?>
        <form action="<?php echo base_url('dapur/dapur_menu/tambah/').@$date.'/'.@$trx; ?>" method="post">
        ...
        <form action="<?php echo base_url('dapur/dapur_menu/edit/').@$date.'/'.@$trx; ?>" method="post">
            <input type="hidden" name="no_dok" value="<?php echo $no_dok; ?>">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                            ...
                            <table class="table table-bordered table-striped my-0 pt-0 w-100" style="width: 100%;">
                                <tbody>
                                    <?php
                                            foreach ($beli as $pb) { ?>
                                    <?php
                                                $cek = $this->db->get_where('dapur_pembelian', ['tanggal' => $date, 'user_id' => $nickname['id'], 'barang_id' => $pb['id']])->num_rows();
                                                if ($cek == 0) { ?>
